...
const Footer = () => {
  return (
    <div className="footer-container">
      <footer className="text-center text-lg-start text-white" style={{ backgroundColor: "#1e1e33" }}>
        {/* Section: Social media */}
        <section className="d-flex justify-content-between p-4" style={{ backgroundColor: "#0d4d8d" }}>
          {/* Left */}
          <div className="me-5">
          ...
          <div className="container text-center text-md-start mt-5">
            <div className="row mt-3">
              ...
              <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                <h6 className=" fw-bold">AirVision</h6>
